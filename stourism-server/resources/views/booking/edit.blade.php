                    ...
                    <div class="card-body">
                        ...
                        <form id="booking-form">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="disabledSelect" name="advance_payment_check" value="{{ $b->advance_payment_check }}" class="form-select">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="advance_payment" value="{{ $b->advance_payment }}" class="form-control" id="exampleInputEmail14">
                            </div>
