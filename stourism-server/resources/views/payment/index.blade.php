            ...
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="table-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title fw-semibold mb-4">Thanh toán</h5>
                    </div>
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            <thead class="text-dark fs-4">
                                <tr>
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Doanh nghiệp</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Doanh thu</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">% Hoa hồng</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Phần còn dư</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        {{-- some thing --}}
                                    </th>
