                ...
                <div class="card-body p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tbody>
{{--                            @foreach($rooms as $index => $product)--}}
{{--                                <tr>--}}
...
{{--                                    </td>--}}
{{--                                    <td class="border-bottom-0">--}}
{{--                                        <p class="mb-0 fw-normal">{{ $product->product_slug }}</p>--}}
{{--                                    </td>--}}
{{--                                    <td class="border-bottom-0">--}}
{{--                                        <img src="/images/{{ $product->product_image }}" alt="product-avatar-{{ $product->product_slug }}" width="80">--}}
{{--                                    </td>--}}
...
{{--                            <input class="my-3" type="hidden" name="id" id="product_slug_delete" value="{{$product->product_slug}}">--}}
    ...
    <script>
        $(document).ready(function () {
            $('#delete-product').on('submit', function (e) {
                e.preventDefault();
                var productSlug = $('#product_slug_delete').val();
                var formData = $(this).serialize();

                $.ajax({
                    type: 'DELETE',
                    url: '/admin/danh-muc/'+ productSlug +'/xoa',
                    data: formData,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                        'Accept': 'application/json'
